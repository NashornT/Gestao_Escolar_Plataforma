    ...
    with app.app_context():
        try:
            ...
            nota_table = Table('notas', academic_metadata,
                               ...
                               Column('nota_1_bimestre', db.Float),
                               Column('nota_1_bimestre_recuperacao', db.Float),
                               Column('nota_1_bimestre_final', db.Float),
                               Column('nota_2_bimestre', db.Float),
                               Column('nota_2_bimestre_recuperacao', db.Float),
                               Column('nota_2_bimestre_final', db.Float),
                               Column('nota_3_bimestre', db.Float),
                               Column('nota_3_bimestre_recuperacao', db.Float),
                               Column('nota_3_bimestre_final', db.Float),
                               Column('nota_4_bimestre', db.Float),
                               Column('nota_4_bimestre_recuperacao', db.Float),
                               Column('nota_4_bimestre_final', db.Float),
                               Column('nota_total', db.Float),
                               Column('media_final', db.Float),
                               Column('total_faltas', db.Integer),
